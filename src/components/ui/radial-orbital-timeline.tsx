...
export default function RadialOrbitalTimeline({
  ...
  const getStatusStyles = (status: TimelineItem["status"]): string => {
    switch (status) {
      ...
      case "pending":
        return "text-white bg-muted border-muted-foreground";
      default:
        return "text-white bg-muted border-muted-foreground";
    }
  };
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute w-80 h-80 md:w-96 md:h-96 rounded-full border border-primary/10"></div>
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 md:w-72 bg-card/90 backdrop-blur-lg border-border shadow-xl shadow-primary/10 overflow-visible">
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-none border-border bg-transparent hover:bg-accent text-muted-foreground hover:text-foreground transition-all"
                                  onClick={(e) => {
                                    e.stopPropagation();
